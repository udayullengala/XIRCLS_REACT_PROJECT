																...
																<Row className="row" id="personal">
																	...
																	<Col className="col-xl-4 col-md-6 col-12 mb-1">
																		<div className="form-group">
																			...
																			<input type="text" className="js-datepicker form-control flatpickr-input" name="birth_date" id="date_of_birth" data-date-format="dd-mm-yyyy" data-week-start="1" placeholder="Date of Birth" data-autoclose="true" data-today-highlight="true"  readonly="readonly"/>
																		</div>
																	...
																	<Col className="col-xl-4 col-md-6 col-12 mb-1">
																		<div className="form-group">
																			...
																			<select id="gender" name="gender" type="text" placeholder="Gender" className="form-control"  onclick="clearError('Gender_val');">
																	...
																	<Col className="col-xl-4 col-md-6 col-12 mb-1">
																		<div className="form-group">
																			...
																			<select id="marital_status" name="marital_status" placeholder="Marital Status" type="text" className="form-control" onclick="clearError('Marital_status_val'); Marriedaniversery();">
																	...
																	<Col className="col-xl-4 col-md-6 col-12 mb-1">
																		<div className="form-group">
																			...
																			<select id="children" name="children" placeholder="Children" type="text" className="form-control"  onclick="clearError('Children_val');Childrendata();">
																	...
																	<div id="no0fchild" style="display: none;" className="col-xl-4 col-md-6 col-12 mb-1">   
																		...
																		<input type="text" className="form-control" maxlength="2" id="no0fchild" name="no0fchild"  placeholder="Number of Children"/>
																	...
																	<Col className="col-xl-4 col-md-6 col-12 mb-1">
																		<div className="form-group">
																			...
																			<select id="occupation" name="occupation" placeholder="Occupation" maxlength="6" className="form-control"  onclick="clearError('Occupation_val');abc();">
																	...
																	<Col className="col-xl-4 col-md-6 col-12 mb-1" id="employed" style="display: none;">   
																		...
																		<input type="text" className="form-control" id="employed" name="employed"  placeholder="Category"/>
																		</div>
																	</Col>
