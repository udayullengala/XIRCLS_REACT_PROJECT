        ...
        <Row className="row" id="personal">
          <Col className="col-xl-4 col-md-6 col-12 mb-1">
            <div className="form-group">
              ...
              <input
                type="text"
                className="js-datepicker form-control flatpickr-input"
                name="birth_date"
                id="date_of_birth"
          ...
          <Col className="col-xl-4 col-md-6 col-12 mb-1">
            <div className="form-group">
              ...
              <select
                ...
                className="form-control"
                value=""
                onclick="clearError('Marital_status_val'); Marriedaniversery();"
              >
                <option selected="" disabled="">
                  Marital Status
                </option>
          ...
          <Col className="col-xl-4 col-md-6 col-12 mb-1">
            <div className="form-group">
              ...
              <select
                ...
                className="form-control"
                value=""
                onclick="clearError('Children_val');Childrendata();"
              >
                <option selected="" disabled="">
                  Children
                </option>
          ...
          <div
            id="no0fchild"
            style="display: none;"
            className="col-xl-4 col-md-6 col-12 mb-1"
          >
            <div className="form-group">
          ...
          <Col className="col-xl-4 col-md-6 col-12 mb-1">
            <div className="form-group">
              ...
              <select
                ...
                className="form-control"
                value=""
                onclick="clearError('Occupation_val');abc();"
              >
                <option selected="" disabled="">
                  Occupation
                </option>
                ...
                <option value="Retired Professional">
          ...
          <Col className="col-4">
            <div className="form-group">
              ...
              <input
                ...
                onclick="clearError('designation')"
              ...
              <div className="input-group-prepend">
                ...
                >
                  <svg
                    ...
                    className="feather feather-twitter font-medium-2"
                  >
              ...
              <div className="input-group-prepend">
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    className="feather feather-facebook font-medium-2"
                  >
              ...
              <div className="input-group-prepend">
                ...
                >
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    className="feather feather-instagram font-medium-2"
                  >
                    <rect
                      x="2"
                      y="2"
            ...
            <div className="d-flex justify-content-sm-between">
              ...
              <div>
                <button
                  type="button"
                  className="btn btn-primary waves-effect waves-float waves-light"
                  onclick="add_customers_validation('save_personal')"
                  value="SAVE"
                >
                  Save
                </button>
