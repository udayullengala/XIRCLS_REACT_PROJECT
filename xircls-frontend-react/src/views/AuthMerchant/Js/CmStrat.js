                    ...
                    <Col md={12} className="h-100" style={{ padding: '2rem' }}>
                        ...
                        <Row>
                            <div id='selectcms' className="d-flex justify-content-evenly">
                                <div>
                                    <Card id='cms1' onClick={() => cardSelect('cms1')} className="my-2 rounded-4 borderremover" style={{ width: '25rem', boxShadow: '0px 0px 15px rgba(0,0,0,0.1)', cursor: 'pointer', position: 'relative' }}>
                                ...
                                <div>
                                    <Card id='cms2' onClick={() => cardSelect('cms2')} className="my-2 rounded-4 borderremover" style={{ width: '25rem', boxShadow: '0px 0px 15px rgba(0,0,0,0.1)', cursor: 'pointer', position: 'relative' }}>
                                        <CardBody className="px-3 text-center">
                                ...
                                <div>
                                    <Card id='cms3' onClick={() => cardSelect('cms3')} className="my-2 rounded-4 borderremover" style={{ width: '25rem', boxShadow: '0px 0px 15px rgba(0,0,0,0.1)', cursor: 'pointer', position: 'relative' }}>
                                        <CardBody className="px-3 text-center">
                                            <img className="mb-3" src='https://www.xircls.com/static/images/website-slide/Infiniti-logo.jpg' width='90' />
                                            <div className="mb-3">
                                                <h4>SemperFi</h4>
                        ...
                        <Row className="w-100 text-right px-1">
                            <button className='btn waves waves-effect waves-dark text-white fs-5' style={{ width: '12.5%', marginLeft: 'auto', backgroundColor: '#19d895' }}>Proceed</button>
                        </Row>
                    </Col>
                </Row>
            </Container>
